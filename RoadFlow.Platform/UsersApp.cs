...
namespace RoadFlow.Platform
{
    public class UsersApp
    {
        ...
        public void AppendUserApps(Guid userID, Guid parentID, List<RoadFlow.Data.Model.RoleApp> appList)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<RoadFlow.Data.Model.UsersApp> GetChilds(Guid id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<RoadFlow.Data.Model.UsersApp> GetAllChilds(Guid id)
        {
        ...
        private void addChilds(Guid id, List<RoadFlow.Data.Model.UsersApp> list)
        {
